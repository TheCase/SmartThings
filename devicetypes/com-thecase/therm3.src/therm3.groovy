metadata {
	...
	definition (name: "Therm3", namespace: "com.thecase", author: "TheCase") {
		capability "Actuator"
...
standardTile("heatLevelUp", "device.heatLevelUp", inactiveLabel: false, decoration: "flat") {
	...
	main "temperature"
	details(["temperature", "mode", "fanMode", "heatLevelDown", "heatingSetpoint", "heatLevelUp", "coolLevelDown", "coolingSetpoint", "coolLevelUp", "battery", "humidity", "refresh", "configure"])    // END CUSTOMIZATION
	}
}
